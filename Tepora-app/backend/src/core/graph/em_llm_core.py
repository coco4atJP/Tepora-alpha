...
class EMEnabledAgentCore:
    ...
    def _build_em_llm_graph(self):
        ...
        workflow.add_node(GraphNodes.SUMMARIZE_SEARCH_RESULT, base_core.summarize_search_result_node)
        ...
        workflow.add_node(GraphNodes.SYNTHESIZE_FINAL_RESPONSE, base_core.synthesize_final_response_node)
        ...
        workflow.add_conditional_edges(
            ...
            {
                "continue": GraphNodes.TOOL_NODE,
                "end": GraphNodes.SYNTHESIZE_FINAL_RESPONSE
            },
        )
