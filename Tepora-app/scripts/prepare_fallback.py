...
# Constants
PROJECT_ROOT = Path(__file__).resolve().parents[1]  # Tepora-app
REPO_ROOT = PROJECT_ROOT.parent  # Tepora_Project (repository root)
STORAGE_DIR = REPO_ROOT / "格納"  # Directory containing downloaded binaries (in repo root)
