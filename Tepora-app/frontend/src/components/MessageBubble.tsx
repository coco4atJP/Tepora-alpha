...
const MessageBubble: React.FC<MessageBubbleProps> = ({ message }) => {
    ...
    return (
        <div className={`flex ${message.role === 'user' ? 'justify-end' : 'justify-start'} animate-message-in group`}>
            <div
            ...
            >
                ...
                <div className="flex flex-col min-w-0">
                            ...
                            <ReactMarkdown
                                ...
                                components={{
                                    code({ className, children, ...rest }) {
                                        ...
                                        return match ? (
                                            <div aria-label={`${match[1]} code block`} className="grid overflow-x-auto w-full max-w-full my-4 rounded-xl border border-white/10 shadow-lg group/code">
                    ...
                    <div className={`text-[10px] opacity-40 mt-1.5 font-mono flex items-center gap-1 ${message.role === 'user' ? 'justify-end text-gold-200/50' : 'justify-start text-gray-500'}`}>
