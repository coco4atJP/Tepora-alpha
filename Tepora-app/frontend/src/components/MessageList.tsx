    ...
    >
      ...
      {messages.length === 0 && (
        <div className="flex flex-col items-center justify-center h-full text-coffee-200/50">
          ...
          <p className="text-lg font-bold tracking-widest uppercase font-display">System Ready</p>
          <p className="text-sm mt-2 opacity-50 font-sans">Select a mode from the dial to begin</p>
        </div>
      )}
