					...
					<div className="settings-form-group__header !mb-0">
						<div>
							...
							{tooltip && (
								<button
									type="button"
									className="group relative inline-flex align-middle bg-transparent border-0 p-0 cursor-help align-text-bottom ml-1"
								>
									<HelpCircle
										size={14}
			...
			<div className="settings-form-group__header">
				<div>
					...
					{tooltip && (
						<button
							type="button"
							className="group relative inline-flex align-middle bg-transparent border-0 p-0 cursor-help ml-1"
						>
							<HelpCircle
								size={14}
								className="text-gray-500 hover:text-gray-300"
