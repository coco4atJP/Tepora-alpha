		...
		<div className="space-y-6">
			...
			>
				<FormGroup
					...
					description={t("settings.memory.max_tokens.description")}
				>
					<FormInput
						type="number"
			...
			>
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
					<FormGroup
						...
						description={t("settings.memory.surprise_gamma.description")}
					>
						<FormInput
							type="number"
					...
					<FormGroup
						...
						description={t("settings.memory.min_event_size.description")}
					>
						<FormInput
							type="number"
					...
					<FormGroup
						...
						description={t("settings.memory.max_event_size.description")}
					>
						<FormInput
							type="number"
					...
					<FormGroup
						...
						description={t("settings.memory.retrieved_events.description")}
					>
						<FormInput
							type="number"
					...
					<FormGroup
						...
						description={t("settings.memory.repr_topk.description")}
					>
						<FormInput
							type="number"
					...
					<div className="flex items-center h-full pt-4">
						<FormGroup
							...
							description={t("settings.memory.boundary_refinement.description")}
						>
