        ...
        <div className="p-8 h-full overflow-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 shadow-lg">
                    <h2 className="text-xl font-bold text-blue-400 mb-4 border-b border-gray-700 pb-2">Character Memory (EM-LLM)</h2>
                    {memoryStats?.char_memory ? (
                        <div className="space-y-4">
                            <StatItem label="Total Events" value={memoryStats.char_memory.total_events} />
                            <StatItem label="Total Tokens" value={memoryStats.char_memory.total_tokens_in_memory} />
                            <StatItem
                ...
                {/* Professional Memory */}
                <div className="bg-gray-800 rounded-lg p-6 border border-gray-700 shadow-lg">
                    <h2 className="text-xl font-bold text-green-400 mb-4 border-b border-gray-700 pb-2">Professional Memory (EM-LLM)</h2>
                    {memoryStats?.prof_memory ? (
                        <div className="space-y-4">
                            <StatItem label="Total Events" value={memoryStats.prof_memory.total_events} />
                            <StatItem label="Total Tokens" value={memoryStats.prof_memory.total_tokens_in_memory} />
                            <StatItem
                                label="Mean Event Size"
