	...
	return (
		<>
			<button
				ref={triggerRef}
				type="button"
				className={`group relative inline-flex align-middle bg-transparent border-0 p-0 cursor-help ${className || ""}`}
			...
			{isVisible &&
				createPortal(
					<div
						className="fixed w-64 p-2 bg-gray-900 border border-white/10 rounded-md shadow-xl text-xs text-gray-300 z-[9999] pointer-events-none text-left"
						style={{
							top: position.top,
							left: position.left,
						}}
