	...
	return (
		<div className="flex flex-col items-center justify-center p-4 max-w-4xl mx-auto animate-fade-in w-full">
			...
			<div className="text-center relative group">
				<div className="absolute top-1/2 left-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(245,158,11,0.15)_0%,transparent_60%)] pointer-events-none animate-slow-breathe" style={{ marginTop: '-300px', marginLeft: '-300px' }} />
